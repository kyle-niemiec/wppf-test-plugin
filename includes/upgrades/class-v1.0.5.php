...
use WPPF\v1_2_3\Plugin\Upgrader_Schema;

if ( ! class_exists( 'v1_0_5', false ) ) {

	/**
	 * A class to control the basic functionality for an Upgrader Schema (super descriptive, ty me).
	 */
	final class v1_0_5 extends Upgrader_Schema {

		/**
		 * Required abstract: return version.
		 */
		final public function get_version() { return '1.0.5'; }
